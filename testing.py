...
title = tk.Label(text="Click below to choose picture for testing....", background = "blue", fg="white", font=("times", 15))
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='C:\\Users\\HP\\Desktop\\finger_vein_detection\\test', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "C:\\Users\\HP\\Desktop\\finger_vein_detection\\testpicture"
    print(fileName)
